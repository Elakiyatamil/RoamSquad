...
router.get('/activities', experienceController.getActivities);
router.post('/destinations/:id/activities', experienceController.createActivity);
router.post('/activities', experienceController.createActivity);
...
router.get('/food', experienceController.getFoodOptions);
router.post('/destinations/:id/food', experienceController.createFoodOption);
router.post('/food', experienceController.createFoodOption);
...
router.get('/accommodation', experienceController.getAccommodationAdmin);
router.post('/destinations/:id/accommodation', experienceController.createAccommodation);
router.post('/accommodation', experienceController.createAccommodation);
...
// Travel Options
router.get('/travel-options', experienceController.getTravelOptions); // Generic GET
...
router.post('/travel-options', experienceController.createTravelOption);
