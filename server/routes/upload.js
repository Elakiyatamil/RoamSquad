...
router.post('/single', uploadController.upload.single('image'), uploadController.uploadSingle);
router.post('/images', uploadController.upload.array('images', 10), uploadController.uploadMultiple);
router.post('/multiple', uploadController.upload.array('images', 10), uploadController.uploadMultiple);
